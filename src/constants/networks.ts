...
export const NETWORKS_INFO: { [key in ChainId]: NETWORK_INFO } = {
  ...
  [ChainId.MUMBAI]: {
    ...
    name: 'Mumbai',
    urlKey: 'mumbai',
    dmmSwapUrl: 'https://orchardswap-test.netlify.app/#/',
    factoryAddress: '0xB61271d05D13A29e6379E18D533f6c1B110d46Db', //todo: check this
    subgraphName: 'orchardfindex/mumbai1',
    subgraphUrls: ['https://api.thegraph.com/subgraphs/name/orchardfindex/mumbai1'],
  ...
  [ChainId.AVAXTESTNET]: {
    ...
    dmmSwapUrl: 'https://orchardswap-test.netlify.app/#/',
    factoryAddress: '0x8A366547C188412c93F2c5bdc776c8f0745545a7',
    subgraphName: 'orchardfindex/fujifirst4',
    subgraphUrls: ['https://api.thegraph.com/subgraphs/name/orchardfindex/fujifirst4'],
    subgraphBlockUrl: 'https://api.thegraph.com/subgraphs/name/ducquangkstn/ethereum-block-fuji',
    etherscanUrl: 'https://testnet.snowtrace.io/',
    kncAddress: '0xCb76B1948F65132F2e52eD681FD26935c9E206F2',
    wethAddress: '0xd00ae08403b9bbb9124bb305c09058e32c39a48c',
    defaultStartTime: 8000000,
    nativeTokenSymbol: 'AVAX',
    nativeTokenWrappedName: 'AVAX (Wrapped)',
    nativeTokenLogo: AvaxLogo,
    etherscanLinkText: 'Snowtrace',
